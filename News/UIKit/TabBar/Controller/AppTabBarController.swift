...
//    
//    // MARK: - Properties
//    private let allTemplatesCoordinator: AllTemplatesCoordinatorProtocol = AllTemplatesCoordinator(navigationController: UINavigationController())
//    
//    private let favoriteTemplatesCoordinator: AllTemplatesCoordinatorProtocol = FavoriteTemplatesCoordinator(navigationController: UINavigationController())
//    
...
//        
//        viewControllers = [allTemplatesCoordinator.navigationController,
//                           favoriteTemplatesCoordinator.navigationController]
//    }
//
